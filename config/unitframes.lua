	...
	visuals = {
		...
		units = {
			...
			party = {
				...
				size = { 90, 17 + 8 + 70 },
				position = { 
				 party1 = {"TOPLEFT", "UICenter", "TOPLEFT", 60, -200},
				 party2 = {"TOPLEFT", "UICenter", "TOPLEFT", 60, -340},
				 party3 = {"TOPLEFT", "UICenter", "TOPLEFT", 200, -200},
				 party4 = {"TOPLEFT", "UICenter", "TOPLEFT", 200, -340},
				},
				backdrop = {
					texture_size = { 256, 64 },
					texture_position = { "TOPLEFT", -83, 24 -(70 + 8)},
			...
			raid = {
				...
				row_margin = 4,
				col_margin = 4,
				position = { "TOPLEFT", "UICenter", "TOPLEFT", 60, -100 },
				
				border = {
					texture_size = { 100, 100 },
					texture_position = { "TOPLEFT", -20, 16},
					textures = {
						normal = path .. [[textures\DiabolicUI_Target_80x80_PortraitBorder.tga]],
						highlight = path .. [[textures\DiabolicUI_Target_80x80_PortraitBorderHighlight.tga]],
						threat = path .. [[textures\DiabolicUI_Target_80x80_PortraitGlow.tga]]
					}
				},
				...
				name = {
					font_object = DiabolicUnitFrameSmall,
					position = { "BOTTOM", 0, 10 }, -- { "TOP", 0, 28 },
					size = { 90 + 40, (select(2, DiabolicUnitFrameSmall:GetFont()))*2 + 2 }
				},
				role = {
					texture_size = { 32, 32 },
					texture_position = { "BOTTOM", 0, 28 },
					texture = path .. [[textures\DiabolicUI_Texture_32x32_RoleIconGrid_Warcraft.tga]]
				},
				leader = {
					texture_size = { 16, 16 },
					texture_position = { "BOTTOM", -30, 40 },
				},
			}
		},
		colors = {
